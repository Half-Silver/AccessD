#!/bin/bash
#
# AccessD minimal microSD card write operation
# Original author: @zbchristian
# Original source URI: https://github.com/AccessD/accessd-tools
...
# The file system is still in read/write mode, so AccessD settings can be saved.
