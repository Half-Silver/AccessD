#!/bin/bash
#
# AccessD Debug log generator
# Author: @billz <billzimmerman@gmail.com>
# Author URI: https://github.com/billz/
# License: GNU General Public License v3.0
# License URI: https://github.com/accessd/accessd-webui/blob/master/LICENSE
#
# Typically used in an ajax call from the AccessD UI, this utility may also
...
# -i, --install     Overrides the default AccessD install location (/var/www/html)
#
# NOTE
...
This process collects debug and troubleshooting information about your AccessD installation.
...
Debug log information contains the AccessD version, current state and configuration of AP
...
Please do NOT paste the log in its entirety to AccessD's discussions, issues or other
...
function _generate_log() {
    ...
    _iw_reg_info
    _systemd_info
    _log_write "AccessD debug log generation complete."
    exit 0
}
...
# Outputs installed AccessD version & settings 
function _accessd_info() {
    ...
    _log_separator "AccessD Install"
    _log_write "AccessD Version: ${version}"
    _log_write "AccessD Installation Directory: ${install_dir}"
    _log_write "AccessD hostapd.ini contents:\n${hostapd_ini}"
    _log_write "AccessD provider.ini: ${provider_ini}"
}
...
# Iterates the contents of AccessD's 090_*.conf files in dnsmasq.d
