#!/bin/bash
#
# AccessD SSL certificate installation functions
...
# Copy rootCA.pem to AccessD web root
function _copy_rootca() {
    _install_log "Copying rootCA.pem to AccessD web root"
...
function _install_complete() {
    ...
    "Enjoy an encrypted SSL connection to AccessD 🔒" \
