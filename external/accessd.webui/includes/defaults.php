...
if (!defined('RASPI_CONFIG')) {
    define('RASPI_CONFIG', '/etc/accessd');
}

$defaults = [
  'RASPI_BRAND_TEXT' => 'AccessD',
  ...
  'RASPI_ADMIN_DETAILS' => RASPI_CONFIG.'/accessd.auth',
  'RASPI_WIFI_AP_INTERFACE' => 'wlan0',
  'RASPI_CACHE_PATH' => sys_get_temp_dir() . '/accessd',
  'RASPI_ERROR_LOG' => sys_get_temp_dir() . '/accessd_error.log',
  'RASPI_DEBUG_LOG' => 'accessd_debug.log',
  ...
  'RASPI_ADBLOCK_LISTPATH' => '/etc/accessd/adblock/',
