...
function DisplaySystem(&$extraFooterScripts)
{
    ...
    if (!RASPI_MONITOR_ENABLED) {
        if (isset($_POST['SaveServerSettings'])) {
            ...
            // Save settings
            if ($good_input) {
                exec("sudo /etc/accessd/lighttpd/configport.sh $serverPort $serverBind " .RASPI_LIGHTTPD_CONFIG. " ".$_SERVER['SERVER_NAME'], $return);
    ...
    if (isset($_POST['RestartLighttpd'])) {
        ...
        exec('sudo /etc/accessd/lighttpd/configport.sh --restart');
    }
