...
<div class="d-flex align-items-center justify-content-between small">
  <div class="text-muted">
    ...
    <span class="ps-2"><?php echo sprintf(_('Created by the <a href="%s" target="_blank" rel="noopener">%s</a>'), 'https://github.com/AccessD', _('AccessD Team')); ?></span>
  </div>
  <div class="text-muted">
    <i class="fas fa-heart heart"></i> <a href="https://docs.accessd.com/insiders" target="_blank" rel="noopener"><?php echo _("Get Insiders"); ?></a>
  </div>
</div>
