...
/**
 * A dnsmasq configuration manager for AccessD
 *
...
class DnsmasqManager
{
    ...
    private const CONF_RASPAP = '090_accessd';
    ...
    public function buildConfig(?array $syscfg, string $iface, bool $wifiAPEnable, bool $bridgedEnable): array
    {
        ...
        if ($wifiAPEnable == 1) {
            ...
            $config = [ '# AccessD '.$_POST['interface'].' configuration' ];
    ...
    {
        $config[] = '# AccessD '. $iface .' configuration';
    ...
    /**
     * Builds a AccessD default dnsmasq config
     * Written to 090_accessd.conf
     *
     * @param array $post_data
     * @return array $config
     */
