 ...
 *
 * @description Class supporting user plugins to extend AccessD
...
class PluginManager
{
    ...
    private function autoloadPlugins(): void
    {
        ...
        foreach ($directories as $dir) {
            ...
            $pluginClass = "AccessD\\Plugins\\$pluginName\\$pluginName"; // fully qualified class name
    ...
    public function getInstalledPlugins(): array
    {
        ...
        if (file_exists($this->pluginPath)) {
            ...
            foreach ($directories as $directory) {
                ...
                $pluginClass = "AccessD\\Plugins\\$directory\\$directory";
