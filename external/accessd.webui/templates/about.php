  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header">
        <div class="row">
          <div class="col">
            <i class="fas fa-info-circle me-2"></i><?php echo _("About AccessD"); ?>
          </div>
        </div><!-- ./row -->
      </div><!-- ./card-header -->
      <div class="card-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div id="errorMsg" data-message="<?php echo _("An error occurred. Check the log at <code>/tmp/accessd_install.log</code>"); ?>"></div>
