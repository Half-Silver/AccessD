    ...
    <?php echo \RaspAP\Tokens\CSRF::hiddenField(); ?>
      ...
      <div class="row">
        <div class="mb-3 col-lg-8 col-md-8">
          <label for="debug">
            <?php echo sprintf(_("To generate a system <a href=\"%s\" target=\"_blank\">debug log</a>, click or tap the button below."), "https://docs.accessd.com/ap-basics/#debug-log"); ;?>
          </label>
          <div class="small"> 
          <?php echo _("Debug log information contains the AccessD version, current state and configuration of AP related services, installed system packages, Linux kernel version and networking details. No passwords or other sensitive data are included."); ?>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="mb-3 col-lg-8 col-md-8">
          <label for="reset">
            <?php echo sprintf(_("To reset AccessD to its <a href=\"%s\" target=\"_blank\">initial configuration</a>, click or tap the button below."), "https://docs.accessd.com/defaults/"); ;?>
          </label>
