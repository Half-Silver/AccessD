  ...
  <div class="row">
    <div class="col-md-6">
      <h4 class="mt-3"><?php echo _("Peer"); ?></h4>
        ...
        <p id="wg-description">
          <small><?php echo _("Enable this option to encrypt traffic by creating a tunnel between AccessD and this peer.") ?></small>
    ...
    <div class="col-md-6 mt-5">
      <figure class="figure w-75 ms-3">
        ...
        <img src="app/img/wg-qr-code.php" class="figure-img img-fluid" alt="AccessD Wifi QR code" style="width:100%;">
