        ...
        <div class="row h-100 justify-content-center align-items-center">
          <div class="col-12">
            ...
            <div class="text-center mb-3">
              <img src="app/img/raspAP-logo.php" class="login-logo" alt="AccessD logo" class="img-fluid" style="max-width: 100px;">
            ...
            <div class="text-center mb-4">
              ...
              <?php echo \RaspAP\Tokens\CSRF::hiddenField(); ?>
                ...
                <div class="small mt-2"><a href="https://docs.accessd.com/authentication/#restoring-defaults" target="_blank"><?php echo _("Forgot password") ?></a></div>
                <img src="app/img/uri-qr-code.php?uri=https://docs.accessd.com/authentication/" class="figure-img img-fluid mt-2" alt="AccessD docs" style="width:75px;">
              </form>
            </div>
          </div><!-- /.col -->
        </div><!-- /.row -->
