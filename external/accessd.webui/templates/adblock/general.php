    ...
    <div class="col-md-6">
      <h4 class="mt-3"><?php echo _("Blocklist settings"); ?></h4>
        ...
        <p id="adblock-description">
          <small><?php echo _("Enable this option if you want AccessD to <b>block DNS requests for ads, tracking and other virtual garbage</b>. Blocklists are gathered from multiple, actively maintained sources and automatically updated, cleaned, optimized and moderated on a daily basis.") ?></small>
          <div>
