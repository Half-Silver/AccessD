<div class="row">
  <div class="col-lg-12">
    <div class="card">
      ...
      <div class="card-footer"><?php echo _("Information provided by accessd.sysinfo"); ?></div>
    </div><!-- /.card -->
  </div><!-- /.col-lg-12 -->
</div><!-- /.row -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-12 mb-3 mt-1" data-message="<?php echo _("Reset complete. Restart the hotspot for the changes to take effect."); ?>" id="system-reset-message"><?php echo _("Reset AccessD to its initial configuration? This action cannot be undone."); ?></div>
      </div>
