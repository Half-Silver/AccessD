    ...
    <div class="mb-3 col-md-6">
      <div class="input-group">
        ...
        <p class="mb-0" id="dhcp-iface-description">
          <small><?php echo _("Enable this option if you want AccessD to assign IP addresses to clients on the selected interface. A static IP address is required for this option.") ?></small>
        </p>
      </div>
     </div>
  </div>
