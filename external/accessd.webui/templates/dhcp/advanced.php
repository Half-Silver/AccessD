    ...
    <div class="col-md-6">
      ...
      <div class="input-group">
        ...
        <p id="no-resolv-description">
          <small><?php echo _("Enable this option if you want AccessD to <b>send DNS queries to the servers configured below exclusively</b>. By default AccessD also uses its upstream DHCP server's name servers.") ?></small>
